...
dalai = User.create(firstname: 'Dalai', lastname: 'Lama', email: 'dalai@email.com', password: 'pudding', profile_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Dalailama1_20121014_4639.jpg/220px-Dalailama1_20121014_4639.jpg', zip_code: 3010, bio: '' )

leonardo = User.create(firstname: 'Leonardo', lastname: 'DaVinci', email: 'leonardo@email.com', password: 'pudding', profile_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg/687px-Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg', zip_code: 3010, bio: '' )

pablo = User.create(firstname: 'Pablo', lastname: 'Picasso', email: 'pablo@email.com', password: 'pudding', profile_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Portrait_de_Picasso%2C_1908.jpg/230px-Portrait_de_Picasso%2C_1908.jpg', zip_code: 3010, bio: '' )

chris = User.create(firstname: 'Chris', lastname: 'Brown', email: 'chris@email.com', password: 'pudding', profile_url: 'http://www.raveituptv.com/wp-content/uploads/2017/03/bondivet_thumb.jpg', zip_code: 3010, bio: '' )

martha = User.create(firstname: 'Martha', lastname: 'Stewart', email: 'martha@email.com', password: 'pudding', profile_url: 'https://pbs.twimg.com/profile_images/793566120640913409/lYM7aDtt_400x400.jpg', zip_code: 3010, bio: '' )

meghan = User.create(firstname: 'Meghan', lastname: 'Markle', email: 'meghan@email.com', password: 'pudding', profile_url: 'https://ybfc7cio5elfu-cdn-storage.azureedge.net/cache/0/4/a/c/e/f/04acefcdd45c78332ea6928cbbd0caa50ef4419a.jpg', zip_code: 3010, bio: '' )

julie = User.create(firstname: 'Julie', lastname: 'Bishop', email: 'julie@email.com', password: 'pudding', profile_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Portrait_of_Julie_Bishop.jpg/220px-Portrait_of_Julie_Bishop.jpg', zip_code: 3010, bio: '' )
